...
**\#\#\#\# Step 1: Create Desktop Credentials**
...
6\. **\*\*Save these\!\*\*** Copy the **\*\*Client ID\*\*** and **\*\*Client Secret\*\*** to a safe place; you will need them for the next task.te the **\*\*Client ID\*\*** and **\*\*Client Secret\*\*** you saved from Task 3\.
